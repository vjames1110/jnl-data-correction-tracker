export const queryKeys = Object.freeze({
  ...
  projectMonitorSites: () => ["project-monitor", "sites"],
  projectMonitorSiteScope: () => [
    "project-monitor",
    "site-scope",
  ],
  ...
  projectMonitorStructures: (params) => [
    "project-monitor",
    "structures",
    params,
  ],
  projectMonitorStructureTypes: (params) => [
    "project-monitor",
    "structure-types",
    params,
  ],
  projectMonitorBuildings: (params) => [
    "project-monitor",
    "buildings",
    params,
  ],
